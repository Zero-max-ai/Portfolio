        ...
        <div className="w-7/12 max-md:w-11/12 mx-auto md:py-80 py-40 flex max-md:flex-col-reverse max-md:gap-8 items-center justify-between">
          <div className="flex flex-col gap-4">
            ...
            <span className="max-md:text-xs">
              MERN / Frontend Developer / Designer
            </span>
            ...
            <Link
              to={"/work"}
              className="bg-cyan-800 hover:bg-cyan-700 duration-150 px-3 py-1 max-md:text-xs rounded-md w-fit hover:underline"
            >
              Projects
            </Link>
          </div>
